...
export const ProductResponseSchema = {
    ...
    required: ['id', 'name', 'revision', 'priceInclVat', 'vat', 'owner', 'category', 'priceExclVat', 'alcoholPercentage', 'featured', 'preferred', 'priceList'],
    type: 'object',
    additionalProperties: false
} as const;
...
posters to the rotation.`
        ...
        'Poster.Trello': {
            type: 'boolean',
            description: 'Whether the Trello poster sync is enabled.'
        },
        Orders: {
            type: 'boolean'
        },
...
for each namespace its in.`
        ...
        scaleFactor: {
            type: 'number',
            format: 'double',
            description: 'Display scale factor. Defaults to 1 (1920x1080)'
        }
    },
    required: ['id', 'createdAt', 'updatedAt', 'name', 'scaleFactor'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const ScreenCreateParamsSchema = {
    ...
    required: ['name', 'scaleFactor', 'defaultHandler'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const LightsGroupCreateParamsSchema = {
    properties: {
        ...
        groupInMiddle: {
            type: 'boolean',
            description: `Whether the group of lights is situated in the middle of the room, or at the side.
...
0 if the lights are positioned in a line (and not in a grid)`,
    ...
    required: ['name', 'defaultHandler', 'groupInMiddle', 'gridSizeX', 'pars', 'movingHeadRgbs', 'movingHeadWheels'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const RgbColorSchema = {
    enum: ['white', 'red', 'green', 'blue', 'yellow', 'lightblue', 'orange', 'rosered', 'purple', 'cyan', 'pink', 'gold', 'brown', 'lightpink', 'lime', 'mint', 'uv', 'blindingwhite'],
    type: 'string'
} as const;
...
export const Pick_IColorsRgb_redChannel_or_greenChannel_or_blueChannel_Schema = {
    properties: {
        redChannel: {
            type: 'number',
            format: 'double'
    ...
    required: ['redChannel', 'blueChannel', 'greenChannel'],
    type: 'object',
...
export const RgbColorSpecificationSchema = {
    properties: {
        definitionLimited: {
            '$ref': '#/components/schemas/Pick_IColorsRgb.redChannel-or-greenChannel-or-blueChannel_'
        },
        hex: {
            '$ref': '#/components/schemas/HexColor'
        },
    ...
    required: ['definitionLimited', 'hex', 'complementary', 'alternative', 'definition'],
    type: 'object'
} as const;
...
export const SongDataSchema = {
    properties: {
        bpm: {
            type: 'number',
            format: 'double',
            description: 'Tempo of the song. Defaults to 130 beats per minute for this song if undefined'
        },
        title: {
            type: 'string'
        },
...
export const PosterTypeSchema = {
    description: 'List of every supported poster type.',
    enum: ['unknown', 'error', 'agenda', 'infima', 'train', 'img', 'logo', 'extern', 'photo', 'video', 'borrel-logo', 'borrel-price-list', 'borrel-wall-of-shame', 'olympics'],
    type: 'string'
} as const;

export const FooterSizeSchema = {
    description: 'List of possible footersizes.',
...
export const PosterResponseSchema = {
    ...
    required: ['id', 'name', 'type', 'enabled', 'createdAt', 'updatedAt', 'footerSize', 'defaultTimeout', 'borrelMode', 'protected', 'trello', 'files'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const CarouselOrderParamsSchema = {
    properties: {
        posterIds: {
            items: {
                type: 'number',
...
export const EnabledParamsSchema = {
    properties: {
        enabled: {
            type: 'boolean'
        }
...
export const MediaPosterRequestSchema = {
    properties: {
        name: {
            type: 'string',
            description: 'Internal name of the poster. Visible in backoffice and database.'
        },
        label: {
            type: 'string',
            description: 'The visible title of the poster on the screens.'
        },
        startDate: {
            type: 'string',
            format: 'date-time',
            description: 'Moment from when the poster should be in rotation.'
        },
        expirationDate: {
            type: 'string',
            format: 'date-time',
            description: 'Moment from when the poster should be out of rotation.'
        },
        accentColor: {
            type: 'string',
            description: 'Color of the progressbar mostly.'
        },
        footerSize: {
            '$ref': '#/components/schemas/FooterSize',
            description: 'The size of the footer. Should be a valid FooterSize.'
        },
        defaultTimeout: {
            type: 'number',
            format: 'double',
            description: 'The time the poster should be on the screens for.'
        },
        borrelMode: {
            type: 'boolean',
            description: 'Whether the poster should only be displayed in borrelMode.'
        },
        trello: {
            type: 'boolean'
        },
    ...
    required: ['name', 'footerSize', 'defaultTimeout', 'borrelMode', 'type'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const ExternalPosterRequestSchema = {
    properties: {
        name: {
            type: 'string',
            description: 'Internal name of the poster. Visible in backoffice and database.'
        ...
        uri: {
            type: 'string',
            description: 'If the poster is of type external this holds the link to the resource.'
        },
        type: {
            '$ref': '#/components/schemas/PosterType.EXTERNAL'
        }
    },
    required: ['name', 'footerSize', 'defaultTimeout', 'borrelMode', 'uri', 'type'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const PhotoPosterRequestSchema = {
    properties: {
        name: {
            type: 'string',
            description: 'Internal name of the poster. Visible in backoffice and database.'
        ...
        albums: {
            ...
            type: 'array',
            description: `If the poster is of type photo this contains the ids of the GEWISweb albums this poster should
pick from.`
        },
        type: {
    ...
    required: ['name', 'footerSize', 'defaultTimeout', 'borrelMode', 'albums', 'type'],
    type: 'object',
    additionalProperties: false
} as const;

export const CreatePosterRequestSchema = {
    anyOf: [
        {
            '$ref': '#/components/schemas/MediaPosterRequest'
        },
        {
            '$ref': '#/components/schemas/ExternalPosterRequest'
        },
        {
            '$ref': '#/components/schemas/PhotoPosterRequest'
        }
    ]
} as const;

export const UpdatePosterRequestSchema = {
    properties: {
        name: {
            type: 'string',
            description: 'Internal name of the poster. Visible in backoffice and database.'
...
export const BeatGeneratorResponseSchema = {
    properties: {
        id: {
            type: 'string'
        },
        ...
        hasPrecedence: {
            type: 'boolean',
            description: `Whether this beat generator overrides the beats of all other generators.
This means that only these beats are acted upon by Aurora and propagated
to all clients that listen to them.`
        }
    },
    required: ['id', 'name', 'hasPrecedence'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const HttpApiExceptionSchema = {
    ...
    required: ['name', 'message', 'statusCode', 'status'],
    type: 'object',
    additionalProperties: false
} as const;
...
export const ISecurityGroupsSchema = {
    ...
    required: ['user', 'color', 'audit', 'beats', 'gdrp', 'scenes', 'effects', 'poster', 'roomresponsible', 'centurion', 'timetrail', 'mode', 'handler', 'audio', 'light', 'screen', 'lightOperation', 'spotify', 'sudosos', 'serverSettings', 'orders', 'timedEvents', 'integrationUsers'],
    type: 'object',
    additionalProperties: false
} as const;
