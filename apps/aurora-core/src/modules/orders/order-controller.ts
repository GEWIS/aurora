...
export class OrderController extends Controller {
  ...
  public async addOrder(@Body() orderRequest: OrderRequest) {
    await this.orderManager.addOrder(orderRequest.orderNumber, orderRequest.timeoutSeconds);
    return this.orderManager.getOrders();
  }
  ...
  public async addOrderWebhook(
    ...
    const expiryTimeSeconds = this.serverSettingsStore.getSetting(
    ...
    if (
      ...
      const webhookKeyUrl = this.serverSettingsStore.getSetting(
  ...
  public async removeOrder(orderNumber: number) {
    await this.orderManager.removeOrder(orderNumber);
    return this.orderManager.getOrders();
  }
}
